package com.senierr.mortal.domain.ui.home.wrapper
...
import com.senierr.mortal.support.utils.DateFormatUtil
 ...
 * @date 2020/5/10
 */
class GanHuoNoImageWrapper : ViewHolderWrapper<GanHuo>(R.layout.item_home_ganhuo_no_image) {
